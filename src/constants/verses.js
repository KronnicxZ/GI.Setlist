export const verses = [
  ...
  {
    reference: 'Salmos 33:1-3',
    verse:
      'Alegraos, oh justos, en Jehová; en los íntegros es hermosa la alabanza. Aclamad a Jehová con arpa; cantadle con salterio y decacordio. Cantadle cántico nuevo; hacedlo bien, tañendo con júbilo.',
  },
  {
    reference: 'Salmos 96:1-2',
    verse:
  ...
  {
    reference: 'Salmos 71:23',
    verse: 'Mis labios se alegrarán cuando cante a ti, y mi alma, la cual redimiste.',
  },
  {
    reference: 'Salmos 98:4-6',
    verse:
  ...
  {
    reference: 'Salmos 104:33',
    verse: 'A Jehová cantaré en mi vida; a mi Dios cantaré salmos mientras viva.',
  },
  // Antiguo Testamento
  {
    reference: '1 Crónicas 16:23-25',
    verse:
      'Cantad a Jehová toda la tierra, proclamad de día en día su salvación. Cantad entre las gentes su gloria, y en todos los pueblos sus maravillas. Porque grande es Jehová, y digno de suprema alabanza, y de ser temido sobre todos los dioses.',
  },
  {
    reference: '2 Crónicas 20:21',
    verse:
  ...
  {
    reference: 'Isaías 12:5',
    verse: 'Cantad a Jehová, porque ha hecho cosas magníficas; sea sabido esto por toda la tierra.',
  },
  {
    reference: 'Jeremías 20:13',
    verse:
      'Cantad a Jehová, load a Jehová; porque ha librado el alma del pobre de mano de los malignos.',
  },
  // Apocalipsis
  {
    reference: 'Apocalipsis 5:9',
    verse:
      'Y cantaban un nuevo cántico, diciendo: Digno eres de tomar el libro y de abrir sus sellos; porque tú fuiste inmolado, y con tu sangre nos has redimido para Dios, de todo linaje y lengua y pueblo y nación.',
  },
  {
    reference: 'Apocalipsis 15:3-4',
    verse:
      'Y cantan el cántico de Moisés siervo de Dios, y el cántico del Cordero, diciendo: Grandes y maravillosas son tus obras, Señor Dios Todopoderoso; justos y verdaderos son tus caminos, Rey de los santos. ¿Quién no te temerá, oh Señor, y glorificará tu nombre? pues sólo tú eres santo; por lo cual todas las naciones vendrán y adorarán delante de ti, porque tus juicios se han manifestado.',
  },
];
