...
const toolsList = [
  {
    id: 'chatai',
    name: 'Asistente IA',
    desc: 'Pregunta sobre acordes, progresiones y teoría musical',
    ...
    bg: 'bg-gradient-to-br from-pink-500/15 to-purple-600/15',
  ...
  },
  {
    id: 'metronome',
    name: 'Metrónomo',
    desc: 'Mantén el tempo con precisión y detecta BPM desde YouTube',
  ...
  },
  {
    id: 'tuner',
    name: 'Afinador',
    desc: 'Afina tu instrumento usando el micrófono en tiempo real',
    icon: 'M12,3L1,9L12,15L21,10.09V17H23V9M5,13.18V17.18L12,21L19,17.18V13.18L12,17L5,13.18Z',
    color: 'from-blue-500 to-cyan-600',
    bg: 'bg-gradient-to-br from-blue-500/15 to-cyan-600/15',
  ...
  },
  {
    id: 'taptempo',
    name: 'Tap Tempo',
    desc: 'Toca al ritmo para descubrir el BPM de cualquier canción',
    icon: 'M13,2.05V4.05C17.39,4.59 20.5,8.58 19.96,12.97C19.5,16.61 16.64,19.5 13,19.93V21.93C18.5,21.38 22.5,16.5 21.95,11C21.5,6.25 17.73,2.5 13,2.03V2.05M5.67,19.74C7.18,21 9.04,21.79 11,22V20C9.58,19.82 8.23,19.25 7.1,18.37L5.67,19.74M7.1,5.74C8.22,4.84 9.57,4.26 11,4.06V2.06C9.05,2.25 7.19,3 5.67,4.26L7.1,5.74M5.69,7.1L4.26,5.67C3,7.19 2.25,9.04 2.05,11H4.05C4.24,9.58 4.8,8.23 5.69,7.1M4.06,13H2.06C2.26,14.96 3.03,16.81 4.27,18.33L5.69,16.9C4.81,15.77 4.24,14.42 4.06,13M10,16.5L16,12L10,7.5V16.5Z',
  ...
  },
  {
    id: 'transposer',
    name: 'Transponer',
    desc: 'Cambia la tonalidad de cualquier canción con un clic',
    ...
    bg: 'bg-gradient-to-br from-purple-500/15 to-violet-600/15',
    border: 'border-purple-500/20',
    iconColor: 'text-purple-400',
  },
  {
    id: 'circle',
    name: 'Círculo de Quintas',
    desc: 'Visualiza relaciones armónicas entre todas las tonalidades',
    icon: 'M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z',
    color: 'from-orange-500 to-red-600',
    bg: 'bg-gradient-to-br from-orange-500/15 to-red-600/15',
  ...
  },
  {
    id: 'progressions',
    name: 'Progresiones',
    desc: 'Explora las progresiones más usadas en música de adoración',
    ...
    bg: 'bg-gradient-to-br from-cyan-500/15 to-teal-600/15',
  ...
  },
  {
    id: 'piano',
    name: 'Dar el Tono',
    desc: 'Referencia auditiva rápida para vocalistas y directores',
    icon: 'M12,14A1,1 0 0,0 13,13A1,1 0 0,0 12,12A1,1 0 0,0 11,13A1,1 0 0,0 12,14M12,1A7,7 0 0,0 5,8V13A1,1 0 0,0 4,14V17A1,1 0 0,0 5,18V19A3,3 0 0,0 8,22H16A3,3 0 0,0 19,19V18A1,1 0 0,0 20,17V14A1,1 0 0,0 19,13V8A7,7 0 0,0 12,1',
    color: 'from-indigo-500 to-blue-600',
    bg: 'bg-gradient-to-br from-indigo-500/15 to-blue-600/15',
        ...
        {toolsList.map((tool, index) => (
          ...
          >
            ...
            <div className="relative z-10 flex items-start space-x-4">
              <div
                className={`w-12 h-12 md:w-14 md:h-14 rounded-xl md:rounded-2xl flex items-center justify-center flex-shrink-0 ${tool.iconColor} bg-black/30 border border-white/10 group-hover:scale-110 transition-transform duration-300`}
              >
