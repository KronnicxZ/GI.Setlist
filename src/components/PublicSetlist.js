      ...
      <div className="flex flex-col items-center justify-center h-screen bg-main text-white px-6 text-center">
        <div className="w-20 h-20 bg-red-500/10 rounded-full flex items-center justify-center text-red-500 mb-6 border border-red-500/20">
          <svg className="w-10 h-10" viewBox="0 0 24 24">
            <path
              fill="currentColor"
              d="M11,15H13V17H11V15M11,7H13V13H11V7M12,2C6.47,2 2,6.47 2,12C2,17.53 6.47,22 12,22C17.53,22 22,17.53 22,12C22,6.47 17.53,2 12,2M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20Z"
            />
          </svg>
        </div>
    ...
    <div className="h-screen flex flex-col bg-main text-white overflow-hidden">
      <header className="shrink-0 px-6 md:px-8 py-6 md:py-10 border-b border-white/5 bg-surface/50 backdrop-blur-md z-40">
        <div className="max-w-5xl mx-auto">
          <div className="text-[10px] font-bold text-primary uppercase tracking-[.3em] mb-2">
            Vista de Músico En Vivo
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-10 p-5 bg-primary/10 border border-primary/20 rounded-2xl flex items-center space-x-4">
            ...
            <p className="text-[10px] md:text-xs font-bold text-primary/80 uppercase tracking-widest leading-relaxed">
              Estás viendo el setlist compartido. Haz clic en cualquier canción para ver la letra y
              cifrado.
            </p>
          </div>
      ...
      <footer className="shrink-0 py-4 bg-black/80 backdrop-blur-md border-t border-white/5 text-center px-6">
        <p className="text-[10px] font-bold text-gray-600 uppercase tracking-widest">
          Desarrollado por <span className="text-primary opacity-80">GI SETLIST TEAM</span> •
          Generación Indetenible
        </p>
      </footer>
    </div>
  );
