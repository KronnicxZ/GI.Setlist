          ...
          <div className="flex items-center space-x-2">
            {setlists && setlists.length > 0 && (
              <div className="relative group/setlist">
                ...
                <div className="absolute right-0 mt-2 w-56 py-2 bg-card border border-white/10 rounded-sub shadow-2xl invisible group-hover/setlist:visible z-30 animate-fade-in glass">
